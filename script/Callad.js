...
module.exports = {
	...
	langs: {
		...
		en: {
			missingMessage: "entre un message pour que je puisse l'envoyer à l'admin",
			sendByGroup: "\n- Sent from group: %1\n- Thread ID: %2",
			sendByUser: "\n- Sent from user",
			content: "\n\nContent:\n══════════════════\n%1\n══════════════════\nReply this message to send message to user",
			success: "ton message a bien été envoyé à %1 admin avec succès. \nVoici la liste des adminz\n!\n%2",
			failed: "An error occurred while sending your message to %1 admin\n%2\nCheck console for more details",
			reply: "📍 Réponse de mon maître%1:\n══════════════════\n%2\n══════════════════\nRepond seulement à cet message sans utiliser callad ",
			replySuccess: "Sent your reply to admin successfully!",
			feedback: "💮Un colis maître\n  %1:\n- Adresse : %2%3\n\nContent:\n══════════════════\n%4\n══════════════════\nReply this message to send message to user",
